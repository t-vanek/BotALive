...
- **Purposeful mining** — tier-gated targets (never mining ore with a tool that drops nothing), access tunnels to buried ore, staircases into the deep (never straight down), vein following, torch placement, and lava/water checks before every block. **Capacity-aware**: a nearly-full backpack stops opening new veins and banks its haul first, so mined drops never despawn onto a full inventory.
