...
- **Těžba s účelem** — tier gating (nekope rudu nástrojem, ze kterého by nic nepadlo), štoly k zasypané rudě, schodiště do hloubky (nikdy kolmo dolů), sledování celých žil, rozmisťování pochodní a kontrola lávy/vody před každým blokem. **Hlídá kapacitu**: skoro plný batoh přestane otvírat nové žíly a nejdřív výtěžek uloží do truhly, takže vytěžené dropy nikdy nepadnou do plného inventáře a nezmizí.
