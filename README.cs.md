...
- **Těžba s účelem** — tier gating napříč **celou vanilla sadou rud** (overworld, deepslate, nether, ancient debris; nekope rudu nástrojem, ze kterého by nic nepadlo), štoly k zasypané rudě, schodiště do hloubky (nikdy kolmo dolů), sledování celých žil, rozmisťování pochodní a kontrola lávy/vody před každým blokem. **Hlídá kapacitu**: skoro plný batoh přestane otvírat nové žíly a nejdřív výtěžek uloží do truhly, takže vytěžené dropy nikdy nepadnou do plného inventáře a nezmizí. Jeden centrální katalog materiálů klasifikuje celou vanillu — co je ruda, cennost, odpad nebo stavební blok — takže nic nepropadne sítem.
- **Stanice a tavicí řetězy** — udírna i blastová pec včetně prerekvizit, soběstačný palivový okruh přes dřevěné uhlí, výběr paliva podle priority; opotřebené nástroje se nahrazují dřív, než prasknou, a opravují u kovadliny (bot si ji vyrobí a postaví, když chybí), nebo **spojí u brusného kamene**, když není čím opravovat — dva opotřebené neočarované kusy udělají jeden funkční, takže bot nikdy neuvázne s rozbitým nářadím, které nemá jak spravit. Každou stanici bot používá **podle potřeby, ne podle role**: kdokoli s ingrediencemi taví, kuje, očarovává i vaří a stanici si sám postaví, když žádná není poblíž — profese mění jen *jak často*, ne *jestli vůbec*.
...
- **Domov a údržba** — boti staví skutečné domy (zdi, dveřní otvor, střecha, natočení), spí v postelích, ukládají do truhel přebytky — nejen odpadní kámen, ale i **samotný výtěžek těžby** (rudy, ingoty, uhlí, drahé kameny nad pracovní rezervu), takže smrt už nesmaže celodenní kopání — opravují creeper díry proti plánu domu a po smrti si běží pro výbavu, než dropy zmizí.
...
- **Nalezení End portálu** — bot už není na cestu do Endu odkázán na náhodu: jakmile nasbírá oči Enderu a je vybavený, **najde nejbližší stronghold** (server-side hledání struktur), dojde k němu a vyhledá zakopaný **rám portálu**, který si zapamatuje – výprava ho pak doplní oky a projde. Portál se dál dá poznat i průchodem, toulkami, drby od kamaráda nebo přes `/botalive end portal`.
- **Výpravy do Endu** — bot, který portál zná, se vybaví a bojuje jako zkušený hráč: nejdřív sestřelit krystaly, endermanům se nekoukat do očí, ochrana hran proti pádu do voidu, usazeného draka mlátit, letícího střílet. Vítězství se slaví v chatu, ukládá jako trofej a zvedá odvahu.
...
- **Vesnice** — společenští boti zakládají a rozšiřují vesnice (s generovanými jmény jako „Pepov“ či „Nová Lhota“), parcely se přidělují v prstencích kolem návsi s dveřmi ke středu a dostavěné domy dostanou udusané cestičky s pochodněmi. Od stupně vesnice boti navíc propojí celé sídlo silniční sítí (hlavní ulice od návsi k domům; město dostane obvodový okruh) — cesty rostou se sídlem, protože se dusají jen po trávě. Vesnice se pak specializuje podle poptávky: staví malé **řemeslné dílny** — kovárnu, kuchyni, dílnu, kompostárnu, enchantovnu či alchymistickou dílnu — pro řemesla, která její členové skutečně dělají, a v každé stojí reálná pracovní stanice, u níž pak řemeslník pracuje. Čerstvá zášť umí bota vyhnat založit si vlastní vesnici — nejlepší kamarádi se stěhují s ním.
- **Společné sklady** — sýpka je konečně instituce, ne prázdná rekvizita: členové do ní nosí přebytky jídla a hladový si vezme ze společné sýpky *dřív, než jde krást* do cizí truhly. Vesnice si navíc postaví společný **sklad**, který funguje **oběma směry**: členové do něj ukládají přebytky materiálu — stavební bloky *i* vytěžené rudy a ingoty nad vlastní pracovní rezervu — a člen, kterému schází materiál pro jeho práci, si ho ze skladu **zase vybere**, místo aby ho šel těžit. Bezdomovec si dobere bloky na první dům; kovář nebo horník bez železa či uhlí si doplní ze společné hromady. Horníci plní, ostatní berou — emergentní dělba práce podle profesí, férová ke skladu (jen deficit, se stropem na dávku).
